#!/usr/bin/env bash
# Numbered NHL xG model stages driver — run all stages in order, or a subset.
#
# Usage:
#   scripts/nhl_models.sh                  # all stages in numbered order
#   scripts/nhl_models.sh 01 05            # by stage number
#   scripts/nhl_models.sh ep xyac          # by model name
