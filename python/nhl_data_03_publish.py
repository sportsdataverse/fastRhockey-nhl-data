"""Stage 03 — publish compiled season assets to the nhl_* release tags.
...
Usage::
    ...
    python -m nhl_data_03_publish -s 2026 [--out-dir nhl] [--dry-run]
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap = argparse.ArgumentParser(prog="python -m nhl_data_03_publish")
