"""Stage 08 — nhl `shifts` season dataset (parse + compile ONE family).

Thin numbered entry over ``nhl_data_build.season`` restricted to the ``shifts``
...
Usage::
    ...
    python -m nhl_data_08_shifts_creation -s 2026 --final-dir _raw/nhl/json/final
    scripts/nhl_data.sh 08
"""
