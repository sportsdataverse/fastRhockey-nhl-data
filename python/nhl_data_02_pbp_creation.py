"""Stage 02 — nhl `pbp` season dataset (parse + compile ONE family).

Thin numbered entry over ``nhl_data_build.season`` restricted to the ``pbp``
...
Usage::
    ...
    python -m nhl_data_02_pbp_creation -s 2026 --final-dir _raw/nhl/json/final
