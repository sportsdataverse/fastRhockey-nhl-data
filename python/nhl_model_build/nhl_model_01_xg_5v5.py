"""Stage 01 — fastRhockey xG 5v5 model.
...
(cv_auc >= 0.82) is frozen just below the 2026-04 observed 0.8322 and is
never lowered.

Usage::

    python -m nhl_model_build.nhl_model_01_xg_5v5 [--force] [--quick]
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap = argparse.ArgumentParser(prog="nhl_model_build.nhl_model_01_xg_5v5")
    ...
    def train():
        ...
        return {
            ...
            "gate_pass": auc is not None and auc >= 0.82,
        }
