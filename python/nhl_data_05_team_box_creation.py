"""Stage 05 — nhl `team_box` season dataset (parse + compile ONE family).

Thin numbered entry over ``nhl_data_build.season`` restricted to the ``team_box``
...
Usage::
    ...
    python -m nhl_data_05_team_box_creation -s 2026 --final-dir _raw/nhl/json/final
    scripts/nhl_data.sh 05
"""
